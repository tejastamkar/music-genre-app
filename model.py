...
pickle.dump(scaler, open('./pickle/scalar.pkl','wb'))
pickle.dump(X_train, open('./pickle/xtrain.pkl','wb'))
...
pickle.dump(xgbc, open('./pickle/xgbc.pkl','wb'))
...
pickle.dump(cbc, open('./pickle/cbc.pkl','wb'))


#KNN
cls = knn() #random_state=seed)
cls.fit(X_train_rfe, y_train)
pickle.dump(cls, open('./pickle/cls.pkl','wb'))
